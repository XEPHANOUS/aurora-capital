...
const AssetTable = ({ assets, type, onAssetSelect }: { assets: Asset[]; type: AssetClass; onAssetSelect: (symbol: string) => void }) => {
      ...
      <Tabs defaultValue="crypto" className="space-y-6">
        ...
        <TabsContent value="crypto" className="space-y-6">
          ...
          <Card className="p-6 bg-card/50 backdrop-blur-sm">
            <AssetTable assets={cryptoAssets} type="crypto" onAssetSelect={onAssetSelect} />
          </Card>
        </TabsContent>
        ...
        <TabsContent value="stocks" className="space-y-6">
          ...
          <Card className="p-6 bg-card/50 backdrop-blur-sm">
            <AssetTable assets={stockAssets} type="stock" onAssetSelect={onAssetSelect} />
          </Card>
        </TabsContent>

        <TabsContent value="etf" className="space-y-6">
          <Card className="p-6 bg-card/50 backdrop-blur-sm">
            <AssetTable assets={etfAssets} type="etf" onAssetSelect={onAssetSelect} />
          </Card>
        </TabsContent>

        <TabsContent value="forex" className="space-y-6">
          <Card className="p-6 bg-card/50 backdrop-blur-sm">
            <AssetTable assets={forexAssets} type="forex" onAssetSelect={onAssetSelect} />
          </Card>
        </TabsContent>
        ...
        <TabsContent value="commodities" className="space-y-6">
          ...
          <Card className="p-6 bg-card/50 backdrop-blur-sm">
            <AssetTable assets={commodityAssets} type="commodity" onAssetSelect={onAssetSelect} />
          </Card>
        </TabsContent>

        <TabsContent value="indices" className="space-y-6">
          <Card className="p-6 bg-card/50 backdrop-blur-sm">
            <AssetTable assets={indexAssets} type="index" onAssetSelect={onAssetSelect} />
          </Card>
        </TabsContent>

        <TabsContent value="realestate" className="space-y-6">
          <Card className="p-6 bg-card/50 backdrop-blur-sm">
            <AssetTable assets={realEstateAssets} type="realestate" onAssetSelect={onAssetSelect} />
          </Card>
        </TabsContent>
      </Tabs>
    </div>
